...
$updaterawan = $_POST['rawan'];
$updateabuzir = $_POST['abuzir'];
...
try {
    ...
    if (empty($nameExist)) {
        ...
        $updateStmt = $conn->prepare("UPDATE `tbl_user` SET `first_name` = :first_name, `last_name` = :last_name, `contact_number` = :contact_number, `email` = :email, `username` = :username, `password` = :password, `rawan` = :rawan, `abuzir` = :abuzir WHERE `tbl_user_id` = :userID");
        ...
        $updateStmt->bindParam(':rawan', $updaterawan, PDO::PARAM_STR);
        $updateStmt->bindParam(':abuzir', $updateabuzir, PDO::PARAM_STR);
        ...
        <script>
            ...
            window.location.href = 'http://localhost/yalanetghayartv/home.php';
        </script>
        ";
        ...
        <script>
            ...
            window.location.href = 'http://localhost/yalanetghayartv/index.php';
        </script>
        ";
    }
