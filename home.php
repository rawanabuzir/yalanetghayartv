...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand ml-5" href="home.php"> Registration List Of Yala Netghayar TV</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="./endpoint/update-user.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="registerPassword"> اكتب المجال الذي ترعب بالتطوع به : </label>
                            <select type="text" class="form-control" id="updatePassword" name="password">
                        ...
                        <div class="form-group">
                            <label for="updateUsername">rawan:</label>
                            <input type="text" class="form-control" id="updaterawan" name="rawan">
                        </div>
                        <div class="form-group">
                            <label for="updatePassword">abuzir:</label>
                            <input type="text" class="form-control" id="updateabuzir" name="abuzir">
                        </div>
            ...
            <table class="table table-hover table-collapse">
                <thead>
                    <tr>
                        ...
                        <th scope="col">التخصص / مجال العمل </th>
                        <th scope="col">رقم الهاتف </th>
                        <th scope="col">الدافع للتطوع</th>
                        <!-- <th scope="col">Username</th> -->
                        <th scope="col">مجال التطوع</th>
                        <th scope="col">المحافظة</th>
                        <th scope="col">أيام التطوع</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td id="rawan-<?= $userID ?>"><?php echo $rawan ?></td>
                        <td id="abuzir-<?= $userID ?>"><?php echo $abuzir ?></td>
                        <td>
    ...
    function update_user(id) {
        ...
        let updaterawan = $("#rawan-" + id).text();
        let updateabuzir = $("#abuzir-" + id).text();
        ...
        $("#updaterawan").val(updaterawan);
        $("#updateabuzir").val(updateabuzir);
