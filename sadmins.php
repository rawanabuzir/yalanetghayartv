            ...
            <div class="registration-form">
                <form action="./endpoint/add-user.php" method="POST">
                    <div class="form-group row">
                        <div class="col-6">
                            <label for="firstName">الاسم الرباعي :</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <label for="lastName"> التخصص / مجال العمل</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-7">
                            <label for="email">دافعك للتطوع :</label>
                            <input type="text" class="form-control" id="email" name="email">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="registerUsername">ايميل:</label>
